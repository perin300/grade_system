...
<!-- Content Wrapper. Contains page content -->
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Property Category</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
 ...
 <!-- Content Header (Page header) -->
    ...
    <section class="content">
      <div class="container-fluid">
              <form role="form" action="{{url('/storepcat')}}" method="POST">
  @csrf
        <div class="row">
          <!-- left column -->
          <div class="col-md-12">
              ...
              <!-- form start -->
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input required type="text" name="pcat_code" class="form-control" id="exampleInputEmail1" 
