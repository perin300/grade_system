...
<!-- Content Wrapper. Contains page content -->
 ...
 <!-- Content Header (Page header) -->
    ...
    <section class="content">
      <div class="container-fluid">
              <form role="form" action="{{url('institute/update/'.$data->id)}}" method="POST">
  @csrf
        <div class="row">
          <!-- left column -->
          <div class="col-md-12">
              ...
              <!-- form start -->
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input required type="text" readonly name="Institute_code" value={{  $data->Institute_code }} class="form-control" id="exampleInputEmail1" 
                    placeholder="Institute Type  Code">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Institute Name</label>
                    <input required type="text" name="Institute_name" class="form-control" value={{  $data->Institute_name }} id="exampleInputEmail1" 
