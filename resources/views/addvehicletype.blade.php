...
<!-- Content Wrapper. Contains page content -->
 ...
 <!-- Content Header (Page header) -->
    ...
    <section class="content">
      <div class="container-fluid">
              <form role="form" action="{{url('/crt_vtype')}}" method="POST">
  @csrf
        <div class="row">
          <!-- left column -->
          <div class="col-md-12">
              ...
              <!-- form start -->
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input required type="text" name="vtype_code" class="form-control" id="exampleInputEmail1" 
                    placeholder="Vehicle Type  Code">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Description</label>
                    <input required type="text" name="vtype_desc" class="form-control" id="exampleInputEmail1" 
